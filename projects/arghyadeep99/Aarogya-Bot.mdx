...
<Contributing>
The interested contributors are requested to properly read the README.md file of the repository, as it contains the <a target="_blank" href="https://github.com/arghyadeep99/Aarogya-Bot#future-scope-of-this-project">future scope</a> of the project as well. Those are the improvements we would like to see in our project and make the chatbot better.
</Contributing>