...
description: A simple extension that search in given base folders for git repositories and list them to easilly and quickly switch between them in VSCode editor
...
Git project manager is a simple, yet powerfull extension to VScode editor that helps you to switch projects quickly and easilly.
