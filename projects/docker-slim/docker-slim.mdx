...
description: Make your containers betters, smaller and more secure with DockerSlim. It's a tool for developers that provides a set of commands to simplify and optimize your developer experience with containers.
languages:
  - Go
tags:
